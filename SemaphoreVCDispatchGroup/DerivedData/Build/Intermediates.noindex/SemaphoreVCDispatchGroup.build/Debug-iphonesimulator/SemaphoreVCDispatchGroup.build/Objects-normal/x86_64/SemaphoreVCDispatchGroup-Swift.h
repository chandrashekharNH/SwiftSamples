...
#ifndef SEMAPHOREVCDISPATCHGROUP_SWIFT_H
#define SEMAPHOREVCDISPATCHGROUP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SemaphoreVCDispatchGroup",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24SemaphoreVCDispatchGroup11AppDelegate")
...
SWIFT_CLASS("_TtC24SemaphoreVCDispatchGroup13SceneDelegate")
...
SWIFT_CLASS("_TtC24SemaphoreVCDispatchGroup14ViewController")
